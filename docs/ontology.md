...
| **dob:UPRNValue**    | `dob:PropertyValue`                                                                                                                                                                                                                       | `schema:propertyID` ⟶ hasValue `"UPRN"`                                                                                                                                                                                                                                                                                                                                                                           | A unique numeric identifier for every spatial address in Great Britain.                                                                                                                                                                                                                                                                                                                                                                   |
| **dob:ODSValue**     | `dob:PropertyValue`                                                                                                                                                                                                                       | `schema:propertyID` ⟶ hasValue `"ODS"`                                                                                                                                                                                                                                                                                                                                                                            | An identifier used by the NHS Organisation Data Service (ODS), which manages reference information about organisations involved in health and social care in England and beyond.                                                                                                                                                                                                                   |
| **dob:Processing** | `prov:Activity`                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                          | A software-based activity used for creating new results from existing results. The aim of this is to mirror the function of the `sosa:Observation` activity. This allows us to maintain discoverability back to the feature of interest as well as combine `sosa:Result`(s) and `dob:AtomicResult`(s) into new results.                                                                                                                                                                                                                                                                                                                         |
| **dob:Enumeration** | `prov:Entity`, `so:Enumeration`                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                          | A software-based activity used for creating new results from existing results. The aim of this is to mirror the function of the `sosa:Observation` activity. This allows us to maintain discoverability back to the feature of interest as well as combine `sosa:Result`(s) and `dob:AtomicResult`(s) into new results.                                                                                                                                                                                                                                                                                                                         |
...
| **dob:CodeRevision**     | `prov:Entity`,`schema:SoftwareSourceCode`                                                                                                                                                                                        | `dob:tagURI` (cardinality = 1)                                                                                                                                                                                                                                                                                                                                                                                    | A specific tagged revision of code in a repository. The property `dob:tagURI` must have exactly one value (e.g., the GitHub URL corresponding to the tag).                                                                                                                                                                                                                                                                               |
