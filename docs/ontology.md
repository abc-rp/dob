...
| **dob:UPRNValue**    | **Subclass Of:**<br/>• `dob:PropertyValue`<br/><br/>**Restriction:**<br/>• `schema:propertyID` ⟶ hasValue `"UPRN"`                                                                                                                                                                                        | A unique numeric identifier for every spatial address in Great Britain.                                                                                                                                                                                                                                                                                                                                                                   |
| **dob:ODSValue**     | **Subclass Of:**<br/>• `dob:PropertyValue`<br/><br/>**Restriction:**<br/>• `schema:propertyID` ⟶ hasValue `"ODS"`                                                                                                                                                                                         | An identifier used by the NHS Organisation Data Service (ODS), which manages reference information about organisations involved in health and social care in England and beyond.                                                                                                                                                                                                                   |
...
| **dob:CodeRevision**     | **Subclass Of:**<br/>• `prov:Entity`<br/>• `schema:SoftwareSourceCode`<br/><br/>**Restriction:**<br/>• `dob:tagURI` (cardinality = 1)                                                                                                                                 | A specific tagged revision of code in a repository. The property `dob:tagURI` must have exactly one value (e.g., the GitHub URL corresponding to the tag).                                                                                                                                                                                                                                                                               |
